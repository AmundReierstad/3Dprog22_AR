...
private:
    ...
    GLint  mMatrixUniformPhong;              //OpenGL reference to the Uniform in the shader program
    GLint  mPmatrixUniformPhong;             // Leksjon 3
    GLint  mVmatrixUniformPhong;             // Leksjon 3
   ...
   /* //QMatrix4x4 *mMVPmatrix{nullptr};         //The matrix with the transform for the object we draw
    ...
    //objects to render
    InteractiveObject* MoveableObject;
    cube* MoveableCube;
    TriangleSurface* triangleFromFile;
    Disc* myDisc;
    std::vector<VisualObject*> mObjects; //container for objects
    //hash map
